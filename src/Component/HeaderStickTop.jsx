  ...
  return (
    <>
      <header dir="rtl" className="bg-[#11217a00] text-white z-50 transition-all sticky top-0 ">
        {/* 🔹 نوار بالایی (اسکرول میره بالا) */}
        <div className="bg-green-600 text-center py-1.5 text-xs sm:text-sm font-medium px-2 text-white">
          ارسال رایگان برای سفارش بالای ۱ میلیون تومان | پشتیبانی ۲۴ ساعته: ۰۹۱۲xxx xxxx
        </div>

        {/* 🔹 هدر اصلی (فقط این sticky) */}
        <div className="w-full bg-[#11207A] py-4 flex items-center justify-between px-4 md:px-60 gap-4 z-50">
          {/* RIGHT SIDE */}
          ...
          <div className="flex items-center gap-2" dir="ltr">
            ...
            <button
              ...
              className="relative w-10 h-10 rounded-xl bg-white/30 flex items-center justify-center text-white transition-all duration-300 hover:bg-[#BBD430] hover:text-[#11207A] hover:ring-1 hover:ring-[#BBD430] hover:ring-offset-1 hover:ring-offset-[#11207A]"
            >
            ...
            <button
              onClick={() => {
                if (!Cookies.get("t1")) setLoginOpen(true);
              }}
