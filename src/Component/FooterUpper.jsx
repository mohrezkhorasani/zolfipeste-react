      ...
      <div className="flex-1 flex flex-col p-4 lg:p-0">
        <div className="flex flex-row items-center gap-3 mb-4">
          ...
          <a
            ...
            className="inline-block text-white transition-colors duration-300 bg-[#2B3992] rounded-md p-2 w-10 h-10 hover:border-2 hover:border-[#2B3992] hover:text-[#2B3992] hover:bg-white"
          >
            <svg
              aria-hidden="true"
              className="w-6 h-6"
      ...
      <div className="flex-1 flex flex-col md:flex-row gap-y-6 md:gap-y-0 md:gap-x-5 w-full  p-4 lg:p-0 md:p-0">
        ...
        <div className="flex-1 flex flex-col justify-center items-start gap-3">
          <div className="flex flex-row items-center gap-3 mb-2">
            ...
            <a
              href="about-us/index.html"
              className="inline-block text-white transition-colors duration-300 bg-[#BBD430] rounded-md px-2 pb-2 pt-1 w-10 h-10 hover:border-2 hover:border-[#BBD430] hover:text-[#BBD430] hover:bg-white"
            >
              <svg
                aria-hidden="true"
          ...
          <ContactusField
            ...
            title="info@zol.com" href="mailto:info@zol.com" />
        </div>
