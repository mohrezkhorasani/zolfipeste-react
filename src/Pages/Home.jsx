...
function HomePage() {
    ...
    return (
        <div dir="rtl" className="min-h-screen bg-white">
            ...
            <section id='popular-products' className="flex flex-col items-center bg-white px-60 pt-8">
            ...
            {/* سکشن اخبار */}
            <section id='news' className="flex flex-col items-center bg-white px-60 pt-[6%]">
